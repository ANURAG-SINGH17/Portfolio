...
const projects = [
  {
    ...
    link: "https://ai-study-assistant-five.vercel.app/",
    backend: "https://ai-study-assistant-n55c.onrender.com/",
    fullstack: true,
  },
  {
    name: "Pinterest",
...
>
  ...
  <div className="flex justify-between items-center w-full max-w-5xl px-6 mb-8">
    ...
    >
      {isDarkMode ? (
        ...
        <Moon className="w-6 h-6 text-black cursor-pointer" />
      )}
    </button>
  </div>
              ...
              <div>
                ...
                <div className="flex gap-4 mt-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-1 bg-black text-white rounded-full h-8 text-sm shadow-md hover:text-blue-500 transition-transform duration-300 ease-in-out hover:scale-105 flex items-center gap-3 transition-colors"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-1 flex items-center text-sm text-black hover:text-blue-500 transition-transform duration-300 ease-in-out hover:scale-105 rounded-lg shadow-md cursor-pointer transition-colors"
                  >
